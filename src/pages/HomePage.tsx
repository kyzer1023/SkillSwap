      ...
      <main className="flex-1">
        ...
        <section className="container py-20 border-t">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={feature.title}
                className={`p-6 rounded-xl border bg-card hover:shadow-lg transition-shadow animate-fade-in stagger-${index + 1}`}
              >
        ...
        <section className="container py-20 border-t">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Two Ways to Exchange</h2>
